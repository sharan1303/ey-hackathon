...
-- Description: Customer and product relationship mapping
...
CREATE INDEX IF NOT EXISTS idx_customer_product_key ON customer_product_keys(customer_code, item_code);
CREATE INDEX IF NOT EXISTS idx_cpk_customer ON customer_product_keys(customer_code);
CREATE INDEX IF NOT EXISTS idx_cpk_item ON customer_product_keys(item_code);

-- ============================================================================
-- Table: pallet_sizes
-- Description: Pallet quantity information for products
